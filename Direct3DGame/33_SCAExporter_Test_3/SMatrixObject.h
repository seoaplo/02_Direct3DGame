...
public:
	...
	Microsoft::WRL::ComPtr<ID3D11Buffer>				m_pMatrixSRVBuffer;
	Microsoft::WRL::ComPtr<ID3D11Buffer>				m_pMatrixUAVBuffer;

	Microsoft::WRL::ComPtr<ID3D11UnorderedAccessView>	m_pMatrixUAV;
	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>	m_pMatrixSRV;
