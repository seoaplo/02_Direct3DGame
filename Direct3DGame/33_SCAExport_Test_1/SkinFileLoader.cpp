...
bool SkinFileLoader::Load(T_STR FilePath)
{
	...
	for (int iMesh = 0; iMesh < SceneData.iNumObjects; iMesh++)
	{
		...
		bCheck = m_Paser.GetDataFromFileNext(InverseMat, &pSkinObject->m_iInverseMatMaxNum, INT_DATA);

		for (int iCount = 0; iCount < pSkinObject->m_iInverseMatMaxNum; iCount++)
		{
			m_Paser.GetNextLine();
			_stscanf_s(m_Paser.m_pBuffer, _T("%f %f %f %f %f"),
				&pSkinObject->m_InvMatrixList[iCount]._11,
				&pSkinObject->m_InvMatrixList[iCount]._12,
				&pSkinObject->m_InvMatrixList[iCount]._13,
				&pSkinObject->m_InvMatrixList[iCount]._14);

			m_Paser.GetNextLine();
			_stscanf_s(m_Paser.m_pBuffer, _T("%f %f %f %f %f"),
				&pSkinObject->m_InvMatrixList[iCount]._21,
				&pSkinObject->m_InvMatrixList[iCount]._22,
				&pSkinObject->m_InvMatrixList[iCount]._23,
				&pSkinObject->m_InvMatrixList[iCount]._24);

			m_Paser.GetNextLine();
			_stscanf_s(m_Paser.m_pBuffer, _T("%f %f %f %f %f"),
				&pSkinObject->m_InvMatrixList[iCount]._31,
				&pSkinObject->m_InvMatrixList[iCount]._32,
				&pSkinObject->m_InvMatrixList[iCount]._33,
				&pSkinObject->m_InvMatrixList[iCount]._34);

			m_Paser.GetNextLine();
			_stscanf_s(m_Paser.m_pBuffer, _T("%f %f %f %f %f"),
				&pSkinObject->m_InvMatrixList[iCount]._41,
				&pSkinObject->m_InvMatrixList[iCount]._42,
				&pSkinObject->m_InvMatrixList[iCount]._43,
				&pSkinObject->m_InvMatrixList[iCount]._44);
		}
		pSkinObject->Init();
