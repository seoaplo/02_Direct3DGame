...
class SLightObj : public SLightInfo
{
public:
...
class SLightMgr : public Singleton < SLightMgr >
{
private:
	friend class Singleton<SLightMgr>;
	ID3D11Device*			m_pDevice;
public:
	typedef map <INT, SLightObj*>					TemplateMap;
...
public:
	...
	SLightObj* const		GetPtr(INT iIndex);
	SLightObj* const		GetPtr(T_STR strFindName);
	bool			Init();
	bool			Frame();
	bool			Render();
	bool			Release();
...
#define I_Light	 SLightMgr::GetInstance()