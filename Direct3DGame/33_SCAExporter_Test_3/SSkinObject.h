...
public:
	...
	Microsoft::WRL::ComPtr<ID3D11Buffer>				m_pConstMatrixBuffer;

	int			m_iInverseMatMaxNum;
	D3DXMATRIX	m_InvMatrixList[AnimationMatrixList];

	Microsoft::WRL::ComPtr<ID3D11Buffer>				m_pInvMatBuffer;
	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>	m_pInvMatBufferSRV;
