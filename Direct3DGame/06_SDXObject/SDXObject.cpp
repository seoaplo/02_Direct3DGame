...
HRESULT SDXObject::LoadShaderAndInputLayout(const T_STR& VSRoute, const CHAR_STRING& VSFunc,
											const T_STR& PSRoute, const CHAR_STRING& PSFunc)
{
	...
	hr = D3DX11CompileFromFile(VSRoute.c_str(), nullptr, nullptr, VSFunc.c_str(), "vs_5_0",
	...
	hr = D3DX11CompileFromFile(PSRoute.c_str(), nullptr, nullptr, PSFunc.c_str(), "ps_5_0", dwShaderFlags, NULL,
...
HRESULT SDXObject::CreateVertexBuffer(vector<PCT_Vertex> SourceVertexList)
{
	HRESULT hr = S_OK;
